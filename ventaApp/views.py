...
from empresaApp.models import ComprobanteConfig, Empresa
from .models import Pedidos, PedidosDetalle, Ventas
from rest_framework import viewsets, status, filters
from rest_framework.pagination import PageNumberPagination
from django_filters import rest_framework as django_filters
from .serializers import PedidosDetalleSerializer, PedidosSerializer, VentasSerializer, CajaSerializer
from sunatApp.views import Sunat 
    ...
    def create(self, request, *args, **kwargs):
        try:
            with transaction.atomic():
                ...
                sunat.enviarSoapSunat(nombre_zip)
