...
class Sunat(APIView):
    ...
    def generarXml(self, id_venta):
        ...
        with open('comprobantes/xml/invoice-signed.xml', 'r', encoding='utf-8') as invoice_file:
...
class VerificadorFirmaXML:
    def __init__(self):
        pass

    def verificar_firma(self, xml_file):
        try:
            # Ejecutar el comando xmlsec para verificar la firma
            result = subprocess.run(["xmlsec1", "verify", xml_file], capture_output=True, text=True)
