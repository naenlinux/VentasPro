<template>
    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0"><router-link to="/pedidos"><i class="fas fa-caret-square-left text-secondary"></i></router-link> Registrar Pedido </h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
  ...
  <div class="card card-primary card-outline">
    <div class="card-body">
      ...
      <div class="row">
        <div class="col-md-2">
          <select name="" class="form-control form-control-lg bg-light" v-model="moneda">
        ...
        <div class="col-md-2">
          <div class="input-group mb-3">
            ...
            <input type="text" class="form-control form-control-lg bg-white" readonly :value="formattedTotal(subtotal=sumaSubtotal)">
          </div>
        ...
        <div class="col-md-2">
          <div class="input-group mb-3">
            ...
            <input type="text" class="form-control form-control-lg bg-white" readonly :value="formattedTotal(sumaigv=sumaIgv)">
          </div>
        ...
        <div class="offset-md-1 col-md-3">
          <div class="input-group ">
            ...
            <input type="text" class="form-control form-control-lg bg-white text-md-left " readonly :value="formattedTotal(sumatotal=sumaTotal)">
          </div>
        </div>
        <div class="col-md-2 text-right">
          <button class="btn btn-primary btn-lg" @click="grabarPedido()"><i class="fas fa-save"></i> Grabar Pedido</button>
        </div>
      </div>
    </div>
  </div><!-- /.card -->
