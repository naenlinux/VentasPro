<template>
    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0"><router-link to="/pedidos"><i class="fas fa-caret-square-left text-secondary"></i></router-link> Detalle de Pedido <strong>N° {{ arrayPedido.numero }}</strong>&nbsp;&nbsp;
  ...
  <div class="card card-primary">
    ...
    <div class="card-body">
      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          <div class="form-group">
            <label for="exampleInputEmail1"><i class="fas fa-shopping-cart"></i> +</label><br>
            <button class="btn btn-secondary">Agregar Producto <i class="fas fa-search"></i></button>
          </div>
        </div>
      </div>
      <br>
      ...
      <div class="row">
        <div class="offset-md-10 col-md-2">
          <div v-if="arrayPedido.activo==1 && arrayPedido.estado=='Pendiente'">
            <button class="btn btn-danger float-right" @click="anularPedido()"><i class="fas fa-trash-alt"></i> Anular Pedido</button>
          </div>
          <div v-else>
            <button class="btn btn-secondary float-right"><i class="fas fa-trash-alt"></i> Anular Pedido</button>
          </div>
        </div>
      </div>
    </div>
