    ...
    export default{   
      ...
      methods:{          
          ...
          validarEmpresa(){
              ...
              if(!this.ruc.trim()) this.arrayMostMsj.push("Ingrese el RUC")
          ...
          registrarEmpresa(){
            ...
            if(!this.id){ // registrar empresa arrayEmpresa esta vacio
                this.$axios.post(`${process.env.VUE_APP_API_URL}/apiempresa/empresa/`, {
                    ...
                    nombre_comercial: me.nombre_comercial.trim(),
                    ruc: me.ruc,
                    direccion: me.direccion.trim(),
                    gerente: me.gerente.trim(),
                    telefono: me.telefono.trim(),
                    correo: me.correo.trim(),
                    ubigeo: me.ubigeo.trim(),
                    ciudad: me.ciudad.trim(),
                    distrito: me.distrito.trim(),
                    provincia: me.provincia.trim(),
                    departamento: me.departamento.trim(),
                })
                .then(function (response) {
                    me.listarEmpresa()
          ...
          registrarSunat(){
            if(this.id == ''){
              me.$toastr.error('Registre primero la empresa', 'Error');
              return
            }
            let me = this
