          ...
          <div class="row">
              <div class="col-sm-4">
                  <div class="input-group">
                      <input type="search" v-model="txtBuscar" @keyup="listarAlmacen(1,txtBuscar,ordenar)" class="form-control form-control-md" placeholder="Buscar producto">
              ...
              <div class="col-sm-4">
                ...
                <div class="input-group-prepend">
                    <label class="input-group-text" for="inputGroupSelect01">Ordenar por stock:</label>
                </div>
                <select class="custom-select" v-model="ordenar" @change="listarAlmacen(1,txtBuscar,ordenar)">
              ...
              <table class="table table-bordered table-sm table-striped">
                  ...
                  <tbody>
                      <tr v-for="a in arrayAlmacen" :key="a.id">
                          ...
                          <td class="text-center" :class="a.total < 1?'bg-danger':(a.cantidad<2?'bg-warning':'bg-success')">{{ a.total+' '+a.uniMedida }}</td>
              ...
              <div class="modal-content" v-on:keyup.enter = "actualizarAlmacen()">
                  ...
                  <div class="modal-body">
                    <div class="mb-3 row">
                      ...
                      <div class="mb-3 row">
                          <label for="" class="col-sm-4 col-form-label">Stock x U/M:</label>
                          <div class="col-sm-8">
...
<script>
    export default{
      ...
      methods:{
          ...
          listarAlmacen(pageNumber = 1,txtBuscar,ordenar){
              let me = this
              this.$axios.get(`${process.env.VUE_APP_API_URL}/apinventario/almacen/?page=${pageNumber}&search=${txtBuscar}&ordenar=${ordenar}`)
          ...
          abrirModal(data=[]){
                ...
                this.showModal = true
                this.tituloModal = data.nombre_producto+' '+data.nombre_unimedida
                this.id = data.id
          ...
          validarCompra(){
            ...
            if(!numerosExp.test(this.precioCompra) || this.precioCompra === '') this.arrayMostMsj.push("El valor Costo producto debe ser numero positivo")
            if(!numerosExp.test(this.total) || this.total === '') this.arrayMostMsj.push("El valor Stock x unidad debe ser numero positivo")
            if(!numerosExp.test(this.cantidad) || this.cantidad === '') this.arrayMostMsj.push("El valor Stock x U/M debe ser numero positivo")
          ...
          actualizarAlmacen(){
            if(this.validarCompra()){
              ...
              .then(function(response){
                  ...
                  me.listarAlmacen(me.currentPage,me.txtBuscar,me.ordenar)
                  me.cerrarModal()
          ...
          abrirModalPrecio(accion,data=[],dato=[]){
            ...
            switch(accion){
                case 'addPrecio':{
                    ...
                    this.producto = data.nombre_producto+' - '+data.nombre_unimedida
                    break
                }
                case 'updatePrecio':{
                    console.log(data)
                    ...
                    this.producto = dato.nombre_producto+' - '+dato.nombre_unimedida
                    break
                }
            }      
        ...
        exportarExcel(){
            window.open(`${process.env.VUE_APP_API_URL}/impresiones/almacenexcel/`, '_blank')
        },
      ...
      mounted(){
        ...
        this.$socket.onmessage = (event) => {
            ...
            this.listarAlmacen(1,this.txtBuscar,this.ordenar)
        }
