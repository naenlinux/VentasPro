<template>
 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <router-link :to="{ name:'dashboard' }" class="brand-link" @click="seleecionarMenu('dashboard','')">
      ...
      <span class="brand-text font-weight-light">Ventas-Pro</span>
    </router-link>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item" :class="{'menu-open':menuPrincipal==='ventas'}" v-if="tipoUsuario == 1">
...
<script>
//Tipo Usuario: 1 Administrador, 2 Cajero, 3 Vendedor, 4 CajeroVendedor
  export default{
